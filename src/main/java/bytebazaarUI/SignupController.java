...
public class SignupController {
    ...
    void performChecks(ActionEvent event) throws IOException {
        ...
        //If the contents of Pass and ConfirmPass are equal and not empty, check for special characters.
        ...
        //Successful signup, display confirmation
            ...
            if(!result.isPresent()){
               ...
               if (BusinessControllerFactory.getBuyerControllerInst().signup("", phoneTextBox.getText(), emailTextBox.getText(), passTextBox.getText()) > 0) {
                ...
                yay.setContentText("You will now be directed to the login screen, please enter your email and password there to login.");
                yay.showAndWait(); 
